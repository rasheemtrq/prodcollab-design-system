...
import Skeleton from '@/app/design-system/components/Skeleton';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faCopy } from '@fortawesome/free-regular-svg-icons';
import { CopyToClipboard } from 'react-copy-to-clipboard';
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import { skeletonCode } from '@/utils/componentCode';
                ...
                <div className="flex flex-col w-full h-auto justify-center items-center bg-primary border border-secondary py-24 px-8 rounded-[2rem] mb-8 overflow-hidden relative">
                    <div className="absolute top-0 flex justify-between w-full p-4">
                        <button
                            ...
                            onClick={() => toggleShowCode('Skeleton')}
                        >
                            {showCode['Skeleton'] ? 'Hide Code' : 'Show Code'}
                        </button>
                        <CopyToClipboard text={skeletonCode} onCopy={() => handleCopy(skeletonCode, 'Skeleton')}>
